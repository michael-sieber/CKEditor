 ...
 */
package org.vaadin.alump.ckeditordemo.demo;
...
public class VaadinCKEditorUI extends UI {
	...
	@VaadinServletConfiguration(productionMode = false, ui = VaadinCKEditorUI.class, widgetset = "org.vaadin.alump.ckeditordemo.demo.WidgetSet")
